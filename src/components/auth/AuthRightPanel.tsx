...
export default function AuthRightPanel() {
  return (
    <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-gray-50 via-slate-100 to-gray-200 items-center justify-center px-12 py-8">
      ...
      <div className="absolute top-1/4 right-1/3 w-[260px] h-[260px] rounded-full bg-gradient-to-br from-primary/30/25 to-transparent blur-[55px] pointer-events-none" />
